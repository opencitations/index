...
from oc_index.glob.csv import CSVDataSource
from oc_index.glob.redis import RedisDataSource
from oc_index.identifier.issn import ISSNManager
from oc_index.identifier.orcid import ORCIDManager
from oc_index.identifier.doi import DOIManager
from oc_index.identifier.pmid import PMIDManager
from oc_index.utils.config import get_config, reset_config

from oc_index.scripts.glob_doci import (
    DataCiteResourceFinder,
    load_json_doci,
    process_doci,
)

from oc_index.scripts.glob_noci import (
...
from oc_index.scripts.glob_crossref import (
    build_pubdate_coci,
    get_all_files_coci,
    load_json_coci,
    process_coci,
...
class GlobTest(unittest.TestCase):
    def setUp(self):
        reset_config()
        config = get_config(join("tests", "config.ini"))
        self.test_dir = join("tests", "data")
