...
class CSVManager(object):
    ...
    def __init__(self, csv_path=None, line_threshold=10000, store_new=True):
        ...
        Args:
            csv_path (str, optional): path where csv are located.
            line_threshold (int, optional): threshold on number of lines, defaults to 10000.
            store_new (bool, optional): true if you want to store data whenever a new item is found, defaults to True.
        """
    ...
    def load_csv_column_as_set(file_or_dir_path, key, line_threshold=10000):
        ...
        Args:
            file_or_dir_path (str): path to csv/s
            key (str): key from row key set
            line_threshold (int, optional): threshold on number of lines, defaults to 10000.
    ...
    def get_value(self, id_string):
        ...
        Args:
            id_string (str): the id to use to retrieve the value

        Returns:
            any: the value associated to the id specified.
        """
    ...
    def add_value(self, id_string, value):
        ...
        Args:
            id_string (str): id to add
            value (any): value to assign to the new item
        """
