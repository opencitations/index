...
def main():
    ...
    parser.add_argument('--out', default='anyid_citation_count.csv', help='Path to the output CSV file (default: citation_count.csv)')
    ...
    with open(args.citations, mode='r') as input_csvfile:
        for row in csv.reader(input_csvfile):
            omid = row[0]
